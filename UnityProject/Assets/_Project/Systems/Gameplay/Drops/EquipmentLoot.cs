...
[System.Serializable]
public struct LootSpreadSettings {
    public float biasUp;           // e.g. 0.3
    public float minSpawnRadius;   // e.g. 0.2
    public float maxSpawnRadius;   // e.g. 0.8
}


[CreateAssetMenu(menuName = "Loot/Equipment")]
public class EquipmentLoot : LootDefinition {
    ...
    public override void SpawnPickup(Vector3 position, int amount, Vector3? impactNormal = null) {
        ...
        pickup.GetComponent<Pickup>().Initialize(equipmentData, amount, spreadDir);
    }
